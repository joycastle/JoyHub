...
public class RouteSecurityPolicyRegistry {
    ...
    private static final List<RouteAuthorizationPolicy> AUTHORIZATION_POLICIES = List.of(
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.POST, "/api/v1/skills/*/*/versions/*/file/translate"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.POST, "/api/web/skills/*/*/versions/*/file/translate"),
            ...
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/web/namespaces/*"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/repositories"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/repositories"),
            ...
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/cli/v1/skills/search"),
            ...
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/cli/v1/namespaces/publish-targets"),
    ...
    private static final List<ApiTokenPolicy> API_TOKEN_POLICIES = List.of(
            ...
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/web/namespaces/*"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/v1/repositories"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/web/repositories"),
            ...
            ApiTokenPolicy.require(HttpMethod.GET, "/api/cli/v1/skills/search", "skill:read"),
            ...
            ApiTokenPolicy.require(HttpMethod.GET, "/api/cli/v1/namespaces/publish-targets", "skill:publish"),
